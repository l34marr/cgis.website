...
#
#  $ bin/test -s cgis.website -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src cgis.website.testing.CGIS_WEBSITE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/cgis/website/tests/robot/test_example.robot
#
